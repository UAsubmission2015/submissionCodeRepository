function [D] = findReturnDensity(P3, T3, power1, power2, flow, P5)
%%%Density [kg/m^3] = findDensity(Pressure3 [bar], Temperature 3 [C], Power 1 [W], Power 2 [W], flow [g/s], local pressure [bar] )
